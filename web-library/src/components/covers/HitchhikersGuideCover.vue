...
.cover-container:not(.hero) .subtitle { font-size: 0.8rem; display: none; }
.cover-container:not(.hero) .status-badge { font-size: 1rem; padding: 2px 8px; margin-top: 10px; }
