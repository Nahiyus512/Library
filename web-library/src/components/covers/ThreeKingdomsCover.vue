<template>
  <div class="three-kingdoms-cover" :class="mode" @mousemove="handleMouseMove" @mouseleave="resetState">
    <!-- Background Texture -->
    ...
    <!-- Title Group -->
    <div class="title-group" :style="titleStyle">
