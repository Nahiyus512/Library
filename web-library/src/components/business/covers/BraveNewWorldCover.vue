<template>
  <div class="brave-cover" :class="{ 'hero': mode === 'hero' }" ref="coverRef" @mousemove="handleMouseMove" @mouseleave="resetParallax">
    <!-- Background Grid -->
